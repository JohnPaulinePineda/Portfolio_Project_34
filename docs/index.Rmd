...
|      **[B.5]** <span style="color: #FF0000">male</span> variable (factor)
|
| **[C]** Optimal penalty parameter setting was determined as:
|      **[C.1]** Lambda=0.061
|
...
|
| **[E]** Externally validated Time-Dependent AUROC metrics usng the test data showed good performance overall except for the last few time periods and are summarized as follows:
