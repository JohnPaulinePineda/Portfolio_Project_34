...
|
| **[A]** The method contains 2 hyperparameters:
|      **[A.1]** <span style="color: #FF0000">nfolds</span> = fold numbers of cross-validation fixed at a value = 5
|      **[A.2]** <span style="color: #FF0000">rule</span> = model selection criterion fixed at a setting of optimal lambda such that error is within 1 standard error of the minimum
|
| **[B]** The method selected 5 out of the 25 predictors for the final Cox Proportional Hazards model as follows:
|      **[B.1]** <span style="color: #FF0000">betablok</span> variable (factor)
|      **[B.2]** <span style="color: #FF0000">peak.vo2</span> variable (numeric)
|      **[B.3]** <span style="color: #FF0000">interval</span> variable (numeric)
|      **[B.4]** <span style="color: #FF0000">bun</span> variable (numeric)
|      **[B.5]** <span style="color: #FF0000">male</span> variable (factor)
|
| **[C]** Optimal model parameter was  was determined as:
|      **[C.1]** Lambda = 0.061
|
| **[D]** Internally validated Time-Dependent AUROC metrics using bootstrap resampling of the train data showed good performance overall except for the last few time periods and are summarized as follows:
|      **[D.1]** 12 months = 0.75935
|      **[D.2]** 24 months = 0.76467
|      **[D.3]** 36 months = 0.65817
|      **[D.4]** 48 months = 0.66612
|      **[D.5]** 60 months = 0.65673
|      **[D.6]** 72 months = 0.67133
|      **[D.7]** 84 months = 0.71603
|      **[D.8]** 96 months = 0.59719
|      **[D.9]** 108 months = 0.67066
|      **[D.10]** 120 months = 0.56227
|
| **[E]** Externally validated Time-Dependent AUROC metrics using the test data showed good performance overall except for the last few time periods and are summarized as follows:
|      **[E.1]** 12 months = 0.75529
|      **[E.2]** 24 months = 0.74168
|      **[E.3]** 36 months = 0.63662
|      **[E.4]** 48 months = 0.62143
|      **[E.5]** 60 months = 0.65494
|      **[E.6]** 72 months = 0.67220
|      **[E.7]** 84 months = 0.65163
|      **[E.8]** 96 months = 0.73170
|      **[E.9]** 108 months = 0.34070
|      **[E.10]** 120 months = 0.32500
|
| **[F]** Model predictions at time = 60 months were reasonably calibrated for both the train and test data. Kaplan-Meier survival curves for the three risk groups from the calibration data were differentially profiled with p-value < 0.05. 
|
| **[G]** Model predictions at time = 120 months were reasonably calibrated for both the train and test data. Kaplan-Meier survival curves for the three risk groups from the calibration data were differentially profiled with p-value < 0.05.
|
|
...
|
| **[A]** The method contains 3 hyperparameters:
|      **[A.1]** <span style="color: #FF0000">nfolds</span> = fold numbers of cross-validation fixed at a value = 5
|      **[A.2]** <span style="color: #FF0000">rule</span> = model selection criterion fixed at a setting of optimal lambda such that error is within 1 standard error of the minimum
|      **[A.3]** <span style="color: #FF0000">alphas</span> = elastic net mixing parameter made to vary across a range of values equal to 0.05 to 0.95
|
| **[B]** The method selected 7 out of the 25 predictors for the final Cox Proportional Hazards model as follows:
|      **[B.1]** <span style="color: #FF0000">betablok</span> variable (factor)
|      **[B.2]** <span style="color: #FF0000">resting.hr</span> variable (numeric)
|      **[B.3]** <span style="color: #FF0000">lvef.metabl</span> variable (numeric)
|      **[B.4]** <span style="color: #FF0000">peak.vo2</span> variable (numeric)
|      **[B.5]** <span style="color: #FF0000">interval</span> variable (numeric)
|      **[B.6]** <span style="color: #FF0000">bun</span> variable (numeric)
|      **[B.7]** <span style="color: #FF0000">male</span> variable (factor)
|
| **[C]** Optimal model parameters were determined as:
|      **[C.1]** Lambda = 0.209
|      **[C.2]** Alpha = 0.200
|
| **[D]** Internally validated Time-Dependent AUROC metrics using bootstrap resampling of the train data showed good performance overall except for the last few time periods and are summarized as follows:
|      **[D.1]** 12 months = 0.76568
|      **[D.2]** 24 months = 0.77544
|      **[D.3]** 36 months = 0.66988
|      **[D.4]** 48 months = 0.67471
|      **[D.5]** 60 months = 0.66267
|      **[D.6]** 72 months = 0.67954
|      **[D.7]** 84 months = 0.71874
|      **[D.8]** 96 months = 0.60604
|      **[D.9]** 108 months = 0.66103
|      **[D.10]** 120 months = 0.46548
|
| **[E]** Externally validated Time-Dependent AUROC metrics using the test data showed good performance overall except for the last few time periods and are summarized as follows:
|      **[E.1]** 12 months = 0.77262
|      **[E.2]** 24 months = 0.74574
|      **[E.3]** 36 months = 0.63438
|      **[E.4]** 48 months = 0.61830
|      **[E.5]** 60 months = 0.65565
|      **[E.6]** 72 months = 0.66441
|      **[E.7]** 84 months = 0.62992
|      **[E.8]** 96 months = 0.69808
|      **[E.9]** 108 months = 0.41854
|      **[E.10]** 120 months = 0.35000
|
| **[F]** Model predictions at time = 60 months were reasonably calibrated for both the train and test data. Kaplan-Meier survival curves for the three risk groups from the calibration data were differentially profiled with p-value < 0.05. 
|
| **[G]** Model predictions at time = 120 months were reasonably calibrated for both the train and test data. Kaplan-Meier survival curves for the three risk groups from the calibration data were differentially profiled with p-value < 0.05.
...
| **[A]** The method contains 2 hyperparameters:
|      **[A.1]** <span style="color: #FF0000">nfolds</span> = fold numbers of cross-validation fixed at a value = 5
|      **[A.2]** <span style="color: #FF0000">gammas</span> = MCP penalty made to vary across a range of values equal to 2.10 to 5.00
|
| **[B]** The method selected 13 out of the 25 predictors for the final Cox Proportional Hazards model as follows:
|      **[B.1]** <span style="color: #FF0000">age</span> variable (numeric)
|      **[B.2]** <span style="color: #FF0000">betablok</span> variable (factor)
|      **[B.3]** <span style="color: #FF0000">acei</span> variable (factor)
|      **[B.4]** <span style="color: #FF0000">aspirin</span> variable (factor)
|      **[B.5]** <span style="color: #FF0000">insulin</span> variable (factor)
|      **[B.6]** <span style="color: #FF0000">resting.systolic.bp</span> variable (numeric)
|      **[B.7]** <span style="color: #FF0000">resting.hr</span> variable (numeric)
|      **[B.8]** <span style="color: #FF0000">lvef.metabl</span> variable (numeric)
|      **[B.9]** <span style="color: #FF0000">peak.vo2</span> variable (numeric)
|      **[B.10]** <span style="color: #FF0000">interval</span> variable (numeric)
|      **[B.11]** <span style="color: #FF0000">cad</span> variable (factor)
|      **[B.12]** <span style="color: #FF0000">bun</span> variable (numeric)
|      **[B.13]** <span style="color: #FF0000">male</span> variable (factor)
|
| **[C]** Optimal model parameters were determined as:
|      **[C.1]** Lambda = 0.014
|      **[C.2]** Gamma = 4.000
|
| **[D]** Internally validated Time-Dependent AUROC metrics using bootstrap resampling of the train data showed good performance overall except for the last few time periods and are summarized as follows:
|      **[D.1]** 12 months = 0.76617
|      **[D.2]** 24 months = 0.77818
|      **[D.3]** 36 months = 0.68530
|      **[D.4]** 48 months = 0.67992
|      **[D.5]** 60 months = 0.66145
|      **[D.6]** 72 months = 0.67633
|      **[D.7]** 84 months = 0.68757
|      **[D.8]** 96 months = 0.61512
|      **[D.9]** 108 months = 0.62571
|      **[D.10]** 120 months = 0.26660
|
| **[E]** Externally validated Time-Dependent AUROC metrics using the test data showed good performance overall except for the last few time periods and are summarized as follows:
|      **[E.1]** 12 months = 0.80360
|      **[E.2]** 24 months = 0.74632
|      **[E.3]** 36 months = 0.64447
|      **[E.4]** 48 months = 0.60192
|      **[E.5]** 60 months = 0.64827
|      **[E.6]** 72 months = 0.60107
|      **[E.7]** 84 months = 0.56609
|      **[E.8]** 96 months = 0.65251
|      **[E.9]** 108 months = 0.46980
|      **[E.10]** 120 months = 0.27500
|
| **[F]** Model predictions at time = 60 months were reasonably calibrated for both the train and test data. Kaplan-Meier survival curves for the three risk groups from the calibration data were differentially profiled with p-value < 0.05. 
|
| **[G]** Model predictions at time = 120 months were reasonably calibrated for both the train and test data. Kaplan-Meier survival curves for the three risk groups from the calibration data were differentially profiled with p-value < 0.05.
...
|      **[A.2]** <span style="color: #FF0000">gammas</span> = MCP penalty made to vary across a range of values equal to 2.10 to 5.00
|
| **[B]** The method selected 15 out of the 25 predictors for the final Cox Proportional Hazards model as follows:
|      **[B.1]** <span style="color: #FF0000">age</span> variable (numeric)
|      **[B.2]** <span style="color: #FF0000">betablok</span> variable (factor)
|      **[B.3]** <span style="color: #FF0000">acei</span> variable (factor)
|      **[B.4]** <span style="color: #FF0000">aspirin</span> variable (factor)
|      **[B.5]** <span style="color: #FF0000">diuretic.thiazide</span> variable (factor)
|      **[B.6]** <span style="color: #FF0000">insulin</span> variable (factor)
|      **[B.7]** <span style="color: #FF0000">resting.systolic.bp</span> variable (numeric)
|      **[B.8]** <span style="color: #FF0000">resting.hr</span> variable (numeric)
|      **[B.9]** <span style="color: #FF0000">lvef.metabl</span> variable (numeric)
|      **[B.10]** <span style="color: #FF0000">peak.vo2</span> variable (numeric)
|      **[B.11]** <span style="color: #FF0000">interval</span> variable (numeric)
|      **[B.12]** <span style="color: #FF0000">cad</span> variable (factor)
|      **[B.13]** <span style="color: #FF0000">bun</span> variable (numeric)
|      **[B.14]** <span style="color: #FF0000">sodium</span> variable (numeric)
|      **[B.15]** <span style="color: #FF0000">male</span> variable (factor)
|
| **[C]** Optimal model parameters were determined as:
|      **[C.1]** Lambda = 0.011
|      **[C.2]** Gamma = 5.000
...
|
| **[E]** Externally validated Time-Dependent AUROC metrics using the test data showed good performance overall except for the last few time periods and are summarized as follows:
|      **[E.1]** 12 months = 0.80297
|      **[E.2]** 24 months = 0.74514
|      **[E.3]** 36 months = 0.64428
|      **[E.4]** 48 months = 0.60077
|      **[E.5]** 60 months = 0.64891
|      **[E.6]** 72 months = 0.60476
|      **[E.7]** 84 months = 0.56636
|      **[E.8]** 96 months = 0.65165
|      **[E.9]** 108 months = 0.45666
|      **[E.10]** 120 months = 0.27500
|
| **[F]** Model predictions at time = 60 months were reasonably calibrated for both the train and test data. Kaplan-Meier survival curves for the three risk groups from the calibration data were differentially profiled with p-value < 0.05. 
|
...
| **[A]** The method contains 3 hyperparameters:
|      **[A.1]** <span style="color: #FF0000">nfolds</span> = fold numbers of cross-validation fixed at a value = 5
|      **[A.2]** <span style="color: #FF0000">lambda1</span> = LASSO penalty made to vary across a range of values equal to 0.001 to 5.000
|      **[A.3]** <span style="color: #FF0000">lambda2</span> = fused LASSO penalty made to vary across a range of values equal to 0.001 to 0.500
|
| **[B]** The method selected 3 out of the 25 predictors for the final Cox Proportional Hazards model. No information about the selected predictors are available.
|
| **[C]** Optimal model parameters were determined as:
|      **[C.1]** Lambda1 = 5.000
|      **[C.2]** Lambda2 = 0.001
|
| **[D]** Internally validated Time-Dependent AUROC metrics using bootstrap resampling of the train data showed good performance overall except for the last few time periods and are summarized as follows:
|      **[D.1]** 12 months = 0.72181
|      **[D.2]** 24 months = 0.71095
|      **[D.3]** 36 months = 0.62796
|      **[D.4]** 48 months = 0.65079
|      **[D.5]** 60 months = 0.63001
|      **[D.6]** 72 months = 0.65456
|      **[D.7]** 84 months = 0.71094
|      **[D.8]** 96 months = 0.57652
|      **[D.9]** 108 months = 0.76628
|      **[D.10]** 120 months = 0.79072
|
| **[E]** Externally validated Time-Dependent AUROC metrics using the test data showed good performance overall except for the last few time periods and are summarized as follows:
|      **[E.1]** 12 months = 0.73644
|      **[E.2]** 24 months = 0.70272
|      **[E.3]** 36 months = 0.58654
|      **[E.4]** 48 months = 0.61131
|      **[E.5]** 60 months = 0.59972
|      **[E.6]** 72 months = 0.63533
|      **[E.7]** 84 months = 0.68976
|      **[E.8]** 96 months = 0.86677
|      **[E.9]** 108 months = 0.46055
|      **[E.10]** 120 months = 0.62500
|
| **[F]** Model predictions at time = 60 months were reasonably calibrated for both the train and test data. Kaplan-Meier survival curves for the three risk groups from the calibration data were differentially profiled with p-value < 0.05. 
|
| **[G]** Model predictions at time = 120 months were reasonably calibrated for both the train and test data. Kaplan-Meier survival curves for the three risk groups from the calibration data were differentially profiled with p-value < 0.05.
...
|
| **[B]** The method which demonstrated consistent time-dependent AUROC across all the time periods was **FLASSO: Fused Least Absolute Shrinkage and Selection Operator** (<mark style="background-color: #CCECFF">**hdnom**</mark> package) with the most optimal number of retained predictors at 3.
|
| **[C]** Lesser number of retained predictors were noted for the **LASSO: Least Absolute Shrinkage and Selection Operator** (<mark style="background-color: #CCECFF">**hdnom**</mark> package) and **ENET: Elastic Net** (<mark style="background-color: #CCECFF">**hdnom**</mark> package) methods with 5 and 7, respectively.
|
| **[C]** Time-dependent AUROC for the **MCP: Minimax Concave Penalty** (<mark style="background-color: #CCECFF">**hdnom**</mark> package) and **SCAD: Smoothly Clipped Absolute Deviation** (<mark style="background-color: #CCECFF">**hdnom**</mark> package) methods were comparable all across the time periods with retained number of predictors equal to 13 and 15, respectively.
|
|
