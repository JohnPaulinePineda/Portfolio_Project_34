...
##################################
PMA_PreModelling_LASSO$died <- as.numeric(PMA_PreModelling_LASSO$died)
...
# for the train data
##################################
LASSO_Predictors <- as.matrix(PMA_PreModelling_LASSO_Train[,!names(PMA_PreModelling_LASSO_Train) 
                                                           %in% c("ttodead","died")])
LASSO_Time    <- PMA_PreModelling_LASSO_Train$ttodead
LASSO_Status  <- PMA_PreModelling_LASSO_Train$died
LASSO_Response <- survival::Surv(LASSO_Time, LASSO_Status)

##################################
# Fitting a LASSO model
##################################
LASSO_CoxPH_Fit <- fit_lasso(LASSO_Predictors,
                              LASSO_Response,
                              nfolds = 5,
                              rule = "lambda.1se",
                              seed = 88888888)
...
##################################
(LASSO_CoxPH_Model  <- LASSO_CoxPH_Fit$model)
(LASSO_CoxPH_Model  <- LASSO_CoxPH_Fit$model$beta)
(LASSO_CoxPH_Alpha  <- LASSO_CoxPH_Fit$alpha)
(LASSO_CoxPH_Lambda <- LASSO_CoxPH_Fit$lambda)
(LASSO_CoxPH_PenaltyFactor <- LASSO_CoxPH_Fit$pen_factor)

##################################
# Formulating a nomogram
# of the LASSO model
##################################
LASSO_CoxPH_Model <- as_nomogram(LASSO_CoxPH_Fit, 
                                 LASSO_Predictors, 
                                 LASSO_Time, 
                                 LASSO_Status,
                                 pred.at = 5,
                                 funlabel = "5-Year Overall Survival Probability"
)

plot(LASSO_CoxPH_Model)
