...
(LASSO_Train_CoxPH_Alpha  <- LASSO_Train_CoxPH_Fit$alpha)
(LASSO_Train_CoxPH_Lambda <- LASSO_Train_CoxPH_Fit$lambda)
(LASSO_Train_CoxPH_PenaltyFactor <- LASSO_Train_CoxPH_Fit$pen_factor)
...
(ENET_Train_CoxPH_PenaltyFactor <- ENET_Train_CoxPH_Fit$pen_factor)
