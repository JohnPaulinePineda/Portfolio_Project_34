...
LASSO_Train_IV_Summary <- data.frame(matrix(ncol=3, nrow=8))
names(LASSO_Train_IV_Summary) <- c("Algorithm","Validation","MedianAUROC")
...
LASSO_Train_EV_Summary <- data.frame(matrix(ncol=3, nrow=8))
names(LASSO_Train_EV_Summary) <- c("Algorithm","Validation","MedianAUROC")
...
ENET_Train_IV_Summary <- data.frame(matrix(ncol=3, nrow=8))
names(ENET_Train_IV_Summary) <- c("Algorithm","Validation","MedianAUROC")
...
ENET_Train_EV_Summary <- data.frame(matrix(ncol=3, nrow=8))
names(ENET_Train_EV_Summary) <- c("Algorithm","Validation","MedianAUROC")
...
MCP_Train_IV_Summary <- data.frame(matrix(ncol=3, nrow=8))
names(MCP_Train_IV_Summary) <- c("Algorithm","Validation","MedianAUROC")
...
MCP_Train_EV_Summary <- data.frame(matrix(ncol=3, nrow=8))
names(MCP_Train_EV_Summary) <- c("Algorithm","Validation","MedianAUROC")
...
SCAD_Train_IV_Summary <- data.frame(matrix(ncol=3, nrow=8))
names(SCAD_Train_IV_Summary) <- c("Algorithm","Validation","MedianAUROC")
...
SCAD_Train_EV_Summary <- data.frame(matrix(ncol=3, nrow=8))
names(SCAD_Train_EV_Summary) <- c("Algorithm","Validation","MedianAUROC")
...
FLASSO_Train_IV_Summary <- data.frame(matrix(ncol=3, nrow=8))
names(FLASSO_Train_IV_Summary) <- c("Algorithm","Validation","MedianAUROC")
...
FLASSO_Train_EV_Summary <- data.frame(matrix(ncol=3, nrow=8))
names(FLASSO_Train_EV_Summary) <- c("Algorithm","Validation","MedianAUROC")
